...
- Adds possibility to specify database port.
- Handles username/password differently in order to prevent problems with password containing special characters.
